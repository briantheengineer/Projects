...
export default function CardSection() {
    return (
        <div>
            <div className="w-full h-max min-h-screen px-5 py-20 flex justify-around flex-wrap gap-6 myblack">
                <h1 className="w-full bcblack myblack text-center text-6xl">Estamos aqui para você se sentir melhor.</h1>
