...
export default function CardSection() {
    return (
        <div>
            <div className="w-full h-max min-h-screen px-5 py-20 flex justify-around flex-wrap gap-6">
                <h1 className="w-full bcblack text-center text-5xl">Estamos aqui para você se sentir melhor.</h1>
